package np.com.sagarDB.database.adapters;
...
import np.com.sagarDB.database.DatabaseHelper;
import np.com.sagarDB.database.EditDetailsActivity;
import np.com.sagarDB.database.R;
